...
const OurClients = () => {
  ...
  const clientLogos = [
    { name: "Astrom", color: "bg-purple-600" },
    { name: "cicio", color: "bg-orange-500" },
    { name: "weavy", color: "bg-blue-500" },
    { name: "vRokets", color: "bg-purple-500" },
    { name: "viewio", color: "bg-indigo-600" },
    { name: "Metablu", color: "bg-orange-600" },
    { name: "Buildaa", color: "bg-gray-800" },
    { name: "hapi", color: "bg-blue-600" },
    { name: "你好", color: "bg-purple-600" },
    { name: "virtuo", color: "bg-purple-700" },
    { name: "Metablu", color: "bg-orange-600" }
  ];
      ...
      <section className="bg-gradient-to-br from-blue-50 to-purple-100 py-20 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <span className="text-gray-600 font-medium tracking-wide">OUR CLIENTS</span>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 text-lg mb-12">
            We collaborate with global leaders to deliver excellence in IT staffing.
          </p>
          ...
          <div className="mb-12">
            <div className="flex justify-center space-x-16 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 font-medium">Direct Clients</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-5 h-5 text-gray-600" />
                <span className="text-gray-700 font-medium">Government & Public Sector</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                <span className="text-gray-700 font-medium">With Our System Integrators</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            {clientLogos.map((client, index) => (
              <div key={index} className="flex items-center justify-center h-16">
                <div className={`px-6 py-2 rounded text-white font-semibold ${client.color}`}>
                  {client.name}
                </div>
              </div>
            ))}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 text-lg mb-12 max-w-3xl mx-auto">
            Explore our core capabilities that power digital transformation and enterprise success.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">IT Staffing Across Technologies</h3>
              <p className="text-gray-600 leading-relaxed">
                We provide skilled IT professionals for full-time, contract, and remote positions across various technologies and domains.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mx-auto mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">End-to-End Application Architecture</h3>
              <p className="text-gray-600 leading-relaxed">
                We design and build scalable IT systems tailored to your business needs, from backend architecture to frontend delivery.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mx-auto mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Quality Analysis & System Support</h3>
              <p className="text-gray-600 leading-relaxed">
                Our QA and support teams ensure your applications run smoothly, with thorough testing and reliable issue resolution.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mx-auto mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Infrastructure & Network Services</h3>
              <p className="text-gray-600 leading-relaxed">
                We help you build and manage robust IT infrastructure, including networks, servers, data centers, and user support.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mx-auto mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Oracle & Microsoft Experts</h3>
              <p className="text-gray-600 leading-relaxed">
                Deep experience with Oracle and Microsoft platforms to support implementations, upgrades, and ongoing support.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mx-auto mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Cloud & DevOps Solutions</h3>
              <p className="text-gray-600 leading-relaxed">
                Enable faster development and deployment with cloud-native strategies, DevOps pipelines, and automation.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                We work with a wide range of commercial clients across industries, delivering reliable and effective IT solutions.
              </p>
            </div>
            <div className="grid grid-cols-5 gap-4">
              {/* Client logo grid */}
              {Array.from({length: 25}, (_, i) => (
                <div key={i} className="w-16 h-16 bg-orange-100 rounded-lg flex items-center justify-center">
            ...
            <div className="bg-white rounded-lg p-8 shadow-sm">
              <div className="w-full h-64 bg-gray-200 rounded-lg mb-6 flex items-center justify-center">
                <div className="text-center text-gray-500">
                  ...
                  <p>Technology Partnership Image</p>
                </div>
              </div>
            </div>
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                From enterprise IT solutions to cloud, automation, and data intelligence, we deliver high-impact results with flexible engagement models.
              </p>
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>We help clients stay ahead by delivering impactful IT solutions tailored to their needs.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Our agile size allows us to offer cost-effective services with personalized attention.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>You receive maximum return on investment through our flexible and scalable delivery models.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Our expertise spans Enterprise Digital Transformation, Data Intelligence & Automation, IT Security, and more.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>We specialize in sourcing hard-to-find IT talent for contract, contract-to-hire, and full-time positions.</span>
                </li>
              </ul>
            </div>
          </div>
