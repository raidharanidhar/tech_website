...
const PlatformEngineeringProductDevelopment = () => {
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center text-gray-600 mb-8">
            ...
            <span>Platform Engineering & Product Development</span>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 text-lg max-w-4xl mx-auto">
            We build secure,scalable,and future-ready platform that power your business,From product design to full-scale engnieering,Tech Project helps enterprices bring ideas tio life and deliver values faster.
          </p>
        </div>
      </section>
...
export default PlatformEngineeringProductDevelopment;