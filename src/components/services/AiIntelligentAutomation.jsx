      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center text-gray-600 mb-8">
            ...
            <span>Digital Strategy & Transformation</span>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 text-lg max-w-4xl mx-auto">
            At TechProjects,we harness the power of AI and Automation to help enterprises stemline operation,improve efficient,and unlock new growth  enters (GCCs) are designed to be more than offshore delivery hubs — they are strategic innovation centers that drive growth Operortunities.Our solution combine machine learning ,RPA,and Intelligent workflow design to reduce maniual effort and drive smater decision making
          </p>
        </div>
      </section>
