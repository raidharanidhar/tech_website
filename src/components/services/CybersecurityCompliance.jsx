...
const CybersecurityCompliance = () => {
  ...
  const sentences = [
    "We help business stay secure and compliant in a fast-changing digital world. From data protection to regulatory compliance, TechProject ensures your systems, people, and processes are safe.",
    "At TechProject, we make hiring simple, fast, and scalable. Our flexible staffing and workforce solutions help businesses find the right people, reduce costs, and build high-performance teams."
  ];
   useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Digital Strategy & Transformation Description Section */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 text-lg max-w-4xl mx-auto text-center transition-all duration-500">
      {sentences[index]}
    </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex">
            ...
            <div className="w-2/3 bg-white rounded-lg p-8">
              {activeTab === 'Why Choose TechProjects?' && (
                <div>
