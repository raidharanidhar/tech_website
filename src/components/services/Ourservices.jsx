      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-gray-600 text-lg max-w-2xl">
            At TechProjects, we help businesses grow, stay secure, and succeed with the right technology and talent.
          </p>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 text-lg mb-16 max-w-4xl mx-auto">
            At TechProjects, we deliver end-to-end technology and workforce solutions that help businesses innovate, scale, and stay ahead. From building Global Capability Centers to driving digital transformation, AI, and talent solutions — we provide the expertise and flexibility to meet your unique needs.
          </p>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="w-1/2">
              <p className="text-lg text-gray-700 mb-8">
                At TechProjects, we go beyond technology support — we design solutions that build, automate, and transform businesses.
              </p>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-gray-600 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-600">Custom-built GCCs for retail, logistics, and government</p>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-gray-600 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-600">Full-service operations: IT, support, analytics, and engineering</p>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-gray-600 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-600">24/7 agile delivery with U.S.–India hybrid teams</p>
                </div>
              </div>

              <div className="mt-8">
                <button className="border border-red-500 text-red-500 px-6 py-3 rounded-lg hover:bg-red-500 hover:text-white transition-colors flex items-center">
                  Read More
